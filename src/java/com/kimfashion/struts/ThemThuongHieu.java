 ...
 * @author HKA
 */
public class ThemThuongHieu extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (!thuongHieuDAO.addNewThuongHieu(th)) {
            return mapping.findForward("ThemThuongHieuNotOK");
        }
        return mapping.findForward("ThemThuongHieuOK");
    }
}
