 ...
 * @author HKA
 */
public class ThemSize extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (!sizeDAO.addNewSize(s)) {
            return mapping.findForward("ThemSizeNotOK");
        }
        return mapping.findForward("ThemSizeOK");
    }
}
