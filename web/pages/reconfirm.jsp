...
<html>
    <head>
        ...
        <title>Gửi mail xác nhận | KimFashion - Cửa hàng thời trang online</title>
                ...
                <div class="container">
                    <div class="relative">
                        <ul class="bc unstyled clearfix">
                            ...
                            <li class="active">Gửi mail xác nhận</li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <html:form action="/ConfirmLai" method="POST" styleClass="form-horizontal" styleId="formXacNhan">
                                    <div class="form-group stylish-input">
                                        ...
                                        <input type="text" name="email" class="form-control" 
                                               ...
                                               value="<bean:write name="ConfirmLaiForm" property="email" />"/>
                                    </div>
