...
<html>
    <head>
        ...
        <title>Hóa đơn đã thanh toán | KimFashion - Cửa hàng thời trang online</title>
                ...
                <div class="container">
                    <div class="relative">
                        <ul class="bc unstyled clearfix">
                            ...
                            <li class="active">Hóa đơn đã thanh toán</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <section class="section">
                            <section class="col-xs-12 col-sm-12 col-md-12">
                                <table id="myTable" class="table table-striped table-bordered table-hover table-condensed">
                                    <caption class="uppercase text-bold"><h3>tất cả hóa đơn đã thanh toán</h3></caption>
                                    <thead>
                                        <tr>
