    ...
    s.prototype.toggle = function(r) {
        ...
        if (!i.is(".disabled, :disabled")) {
            var s = n(i),
                    o = s.hasClass("open");
            if (t(), !o) {
                if ("ontouchstart" in document.documentElement && !s.closest(".navbar-nav").length && e('<div class="dropdown-backdrop"/>').insertAfter(e(this)).on("click", t), s.trigger(r = e.Event("show.bs.dropdown")), r.isDefaultPrevented())
                    return;
...
(function(e) {
    ...
    e.rateit = {
        ...
        if (this.length == 0)
            return this;
        if (f = e.type(r), f == "object" || r === undefined || r == null)
            o = e.extend({}, e.fn.rateit.defaults, r);
        else {
            if (f == "string" && i === undefined)
                return this.data("rateit" + a(r));
            f == "string" && (u = "setvalue")
        }
        return this.each(function() {
            var f = e(this),
    ...
    n.getListeners = function(e) {
        ...
        for (i in o)
            if (o.hasOwnProperty(i))
                for (r = o[i].length; r--; )
                    n = o[i][r], s = n.listener.apply(this, t || []), (s === this._getOnceReturnValue() || n.once === !0) && this.removeListener(e, o[i][r].listener);
        return this
...
(function(e) {
    function t(t) {
        if (t && void 0 === t.allowPageScroll && (void 0 !== t.swipe || void 0 !== t.swipeStatus))
            t.allowPageScroll = u;
        t || (t = {});
    ...
    function n(t, n) {
        ...
        function D(e, t) {
            ...
            if (t === v && n.click && (1 === Z || !m) && (isNaN($) || 0 === $))
                u = n.click.call(Q, e, e.target);
            if (t == d)
                switch (n.swipe && (u = n.swipe.call(Q, e, J, $, K, Z)), J) {
                    case r:
...
(function(e, t, n, r) {
    ...
    var u = function(n) {
        ...
        n.find("label").hoverIntent({
            over: function() {
                if (e(this).siblings("a").hasClass("disabled"))
                    return;
...
(function() {
    ...
    n.RetinaImagePath = e, e.confirmed_paths = [], e.prototype.is_external = function() {
        ...
        if (this.is_external())
            return t(!1);
        if (this.at_2x_path in e.confirmed_paths)
            return t(!0);
...
jQuery(function(e) {
    ...
    e(document).on("click", ".styled-dd", function(t) {
        t.stopPropagation();
        if (e(t.target).hasClass("styled-dd"))
            e(this).find("select").simulate("mousedown")
    });
