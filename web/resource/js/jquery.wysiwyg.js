...
(function( $ )
{
    ...
    $.fn.wysiwyg = function( options )
    {
        ...
        options = $.extend({
            html : '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body style="margin: 0px;font-family:Open Sans">INITIAL_CONTENT</body></html>',
            css  : {},
    ...
    $.extend(Wysiwyg, {
        ...
        MSGS_EN : {
            nonSelection : 'Chọn đoạn văn bạn bạn muốn chèn liên kết trước'
        },

        TOOLBAR : {
            bold          : { visible : true, tags : ['b', 'strong'], css : { fontWeight : 'bold' }, tooltip : "Chữ đậm" },
            italic        : { visible : true, tags : ['i', 'em'], css : { fontStyle : 'italic' }, tooltip : "Chữ nghiêng" },
            strikeThrough : { visible : true, tags : ['s', 'strike'], css : { textDecoration : 'line-through' }, tooltip : "Gạch giữa" },
            underline     : { visible : true, tags : ['u'], css : { textDecoration : 'underline' }, tooltip : "Gạch chân" },

            separator00 : { visible : true, separator : true },

            justifyLeft   : { visible : true, css : { textAlign : 'left' }, tooltip : "Căn trái" },
            justifyCenter : { visible : true, tags : ['center'], css : { textAlign : 'center' }, tooltip : "Căn giữa" },
            justifyRight  : { visible : true, css : { textAlign : 'right' }, tooltip : "Căn phải" },
            justifyFull   : { visible : true, css : { textAlign : 'justify' }, tooltip : "Căn đều 2 bên" },

            separator01 : { visible : true, separator : true },

            indent  : { visible : true, tooltip : "Lùi vào 1 tab" },
            outdent : { visible : true, tooltip : "Lùi ra 1 tab" },
            ...
            undo : { visible : true, tooltip : "Quay lại" },
            redo : { visible : true, tooltip : "Tiến lên" },

            separator04 : { visible : true, separator : true },

            insertOrderedList    : { visible : true, tags : ['ol'], tooltip : "Chèn list có thứ tự" },
            insertUnorderedList  : { visible : true, tags : ['ul'], tooltip : "Chèn list không thứ tự" },
            insertHorizontalRule : { visible : true, tags : ['hr'], tooltip : "Chèn gạch ngang" },
            ...
            createLink : {
                ...
                exec    : function()
                {
                    ...
                    if ( selection.length > 0 )
                    {
                        ...
                        {
                            var szURL = prompt('Chèn liên kết', 'http://');
            ...
            insertImage : {
                ...
                exec    : function()
                {
                    ...
                    {
                        var szURL = prompt('Đường dẫn ảnh', 'http://');
